...
// real client. See the companion package internal/oauth/coderabbit
// for the OAuth side.
package coderabbit
...
const defaultBaseURL = "https://api.coderabbit.ai"
...
func New(opts ...Option) (fantasy.Provider, error) {
	...
	if o.accessToken == "" {
		return nil, errors.New("coderabbit: missing access token; sign in with `atlas login coderabbit`")
	}
...
// TODO(coderabbit): wire this up to the CodeRabbit backend.
func (m *languageModel) Generate(_ context.Context, _ fantasy.Call) (*fantasy.Response, error) {
	return nil, errors.New("coderabbit: Generate not yet implemented; finish the CodeRabbit request envelope (see internal/oauth/coderabbit package docs)")
}

func (m *languageModel) Stream(_ context.Context, _ fantasy.Call) (fantasy.StreamResponse, error) {
	return nil, errors.New("coderabbit: Stream not yet implemented; finish the CodeRabbit SSE envelope (see internal/oauth/coderabbit package docs)")
}
