...
func TestAtlasInfo_MinimalConfig(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_ConfigFiles(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildAtlasInfo(cfg, mgr, nil, nil, nil)
...
func TestAtlasInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Options(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_TUIOptionsUnpinnedCompletionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildAtlasInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildAtlasInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestAtlasInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildAtlasInfo(store, nil, nil, nil, nil)
...
func TestAtlasInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "atlas-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("atlas-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildAtlasInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "atlas-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestAtlasInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "atlas-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestAtlasInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestAtlasInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
