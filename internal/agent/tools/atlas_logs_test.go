...
func TestNewAtlasLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewAtlasLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, AtlasLogsToolName, tool.Info().Name)
}

func TestAtlasLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 3})
...
func TestAtlasLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 0})
...
func TestAtlasLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 200})
...
func TestAtlasLogs_MalformedLines(t *testing.T) {
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 10})
...
func TestAtlasLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 1})
...
func TestAtlasLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestAtlasLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestAtlasLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestAtlasLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestAtlasLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestAtlasLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestAtlasLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runAtlasLogs(logFile, AtlasLogsParams{Lines: 5})
...
func TestAtlasLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
