...
// fully detached from Atlas-Agent's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Atlas-Agent's process
// group.
...
// from Atlas-Agent's session and controlling terminal.
//
